<template>
<div class="m-4 sm:m-8 md:flex md:m-8 ">
  <!-- image card-->
    <div class="relative pb-5/6 md:w-2/3 rounded-lg overflow-hidden shadow-lg">
    ...
    <div class="relative -mt-1 bg-white rounded-b-lg md:mt-0 md:rounded-b-none md:rounded-r-lg md:-ml-4 md:flex md:w-1/3  md:p-0 shadow-lg">
      <div class="p-6 pt-2 w-full">
        ...
        <div class="flex w-full mt-2 md:inline-block">
          ...
          <button class="w-1/2 ml-3 md:ml-0 md:mt-3 md:w-full bg-gray-100  border border-gray-700  text-gray-700 font-semibold py-1 px-4  rounded-lg  hover:bg-gray-100 hover:text-gray-900">Learn More</button>
        </div>
