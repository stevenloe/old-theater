...
<div class="m-4 sm:m-8 md:m-8 ">
  <!-- image card-->
    ...
    <div class=" bg-yellow-900 rounded-b-lg  pl-6 pr-6 pt-3 pb-4 pr-4 shadow-lg">
      ...
      <g-link to="/education/" class=" block  mb-3 bg-yellow-800  text-center border-2 border-white  text-white font-semibold text-lg py-2 px-4  tracking-wider rounded-lg shadow-md hover:bg-yellow-700 uppercase sm:w-1/3">{{ item.cta }}</g-link>
    </div>
  </div>
</template>
