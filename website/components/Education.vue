<template>
  <div class="m-4 sm:m-8 md:m-8 ">
    ...
    <div class=" bg-blue-500 rounded-b-lg  pl-6 pr-6 pt-3 pb-4 shadow-lg">
      ...
      <nuxt-link to="/education" class="block mb-3 bg-green-600  text-center border-2 border-white text-white font-semibold text-lg py-2 px-4 shadow-md rounded-lg tracking-wide hover:bg-green-700 hover:shadow-sm uppercase sm:w-1/3">{{ item.cta }}</nuxt-link>
    </div>
  </div>
</template>
