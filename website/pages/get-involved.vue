    ...
    >
      <div class="p-8 bg-white rounded shadow-lg">
        <div class="mb-4">
          ...
          <p class="mb-2">
            Quis voluptate pariatur minim officia anim sunt fugiat exercitation
            adipisicing voluptate ea commodo consequat exercitation. Sit aliquip
            culpa excepteur excepteur cillum duis enim nisi irure occaecat
            cillum. Nulla eiusmod aute elit proident ipsum magna aliqua
            voluptate enim aute elit eu veniam. Sint elit in eiusmod aliqua ut
            aliqua velit irure et fugiat. Id est est dolore nisi nostrud ex.
            Veniam aute duis ea consequat laboris. Ad exercitation et amet
            laborum deserunt dolore consectetur ad.
          </p>
          <p class="mb-2">
            Enim deserunt Lorem veniam dolore mollit voluptate eiusmod fugiat
            ullamco. Aliqua consequat sint incididunt irure deserunt occaecat
            non anim. In id eu sunt eu consectetur minim.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius sint
            amet enim earum. Eligendi reprehenderit aliquid eveniet nostrum!
            Error deleniti maiores quae dolore, cupiditate ullam dolorem earum
            impedit quas soluta!
          </p>
        </div>
