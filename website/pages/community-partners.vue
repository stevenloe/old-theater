    ...
    <div class="w-full max-w-4xl mx-auto lg:text-xl xl:text-2xl">
      ...
      <div class="p-8 bg-white rounded shadow-lg content-border">
        <div class="mb-4">
          ...
          <p class="mb-4 leading-7 text-gray-900 text-medium lg:leading-9 lg:mb-6">
            ...
            partner with local arts organizations to help them bring
            educational, live theater, &amp; live music performances to our
            stage.
          </p>
          <p class="mb-4 leading-7 text-gray-900 text-medium lg:leading-9 lg:mb-6">
      ...
      <div class="p-8 mb-8 bg-pink-100 rounded-lg shadow-lg content-border">
        ...
        <p class="mb-4 leading-7 text-gray-900 text-medium lg:leading-9 lg:mb-6">
          ...
          theater skills such as acting fundamentals, learning to speak on
          stage, using drama exercises by playing theater games, see the
      ...
      <div class="p-8 pt-4 mb-8 bg-indigo-100 rounded-lg shadow-lg content-border">
        ...
        <p class="mb-4 leading-7 text-gray-900 text-medium lg:leading-9 lg:mb-6">
          ...
          surrounding counties. Ages range from the young, to the young at
          heart! It doesn't matter what experience you have. Only thing that
          matters, is that you have a passion for music!
        </p>
        <p class="mb-4 leading-7 text-gray-900 text-medium lg:leading-9 lg:mb-6">
          More at their
          <a
