...
<div class="w-full px-3 mb-3 md:w-1/2 md:mb-0"><label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="lastname">Last Name <span class="ml-1 text-gray-600">(required)</span></label><input id="lastname" class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-200 border border-gray-800 rounded appearance-none focus:bg-white focus:border-gray-900 focus:outline-none" type="text" name="lastname" placeholder="Doe" required /></div></div>
...
<div class="w-full px-3 mb-3 md:w-1/2 md:mb-0"> <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="phone">Phone </label> <input class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-200 border border-gray-800 rounded appearance-none focus:bg-white focus:border-gray-900 focus:outline-none" id="phone" name="phone" type="text" placeholder="252-555-4444"/></div>
</div>
<div class="flex flex-wrap mb-6 -mx-3">
<div class="w-full px-3"><label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="message">Message <span class="ml-1 text-gray-600">(required)</span></label>
<textarea id="message" name="message" rows="8" cols="50" class="block w-full px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-200 border border-gray-800 rounded appearance-none focus:bg-white focus:border-gray-900 focus:outline-none" placeholder="Message" required></textarea>
