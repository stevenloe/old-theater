<template>
    <div class="container md:mx-auto max-w-3xl">
      ...
      <div class="mb-4">
        <h1 class="text-4xl font-extrabold">Community &amp; Education</h1>
        <div>
      ...
      <div class="mb-4 p-8 pt-4 bg-blue-200">
        <h2 class="text-2xl font-semibold mb-1">Community Band</h2>
        <div>
      ...
      <div class="mb-4 p-8 pt-4">
        <h2 class="text-2xl font-semibold">Pamlico Chorale</h2>
